...
if __name__ == "__main__":
    ...
    host_port = 25                       # smtp 邮件服务器端口：SSL 连接
    from_addr = "285267803@qq.com"                # 发件地址
    pwd = "urikjpgxgboxcafd"                  # 发件地址的授权码，而非密码
    ...
    to_addr_list = ["penbabn_2010@163.com", "285267803@qq.com"]       # 收件地址
    ...
    """
    email_subject = "业务数据biao"
    email_from = "285267803@qq.com"
    source_path = r"F:\github\img\weekly.png"
    part_name = 'weekly.png'
